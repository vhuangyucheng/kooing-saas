package com.kooing.saas.param.util;
...
public class DbToPojoUtil {
    ...
    //数据库连接
    private static final String URL = "jdbc:mysql://localhost:3306/db_kooing2_saas?useUnicode=true&characterEncoding=utf-8";
    ...
    public DbToPojoUtil() {
        ...
        try {
            ...
            try {
                ...
                String test1 =directory.getAbsolutePath();
